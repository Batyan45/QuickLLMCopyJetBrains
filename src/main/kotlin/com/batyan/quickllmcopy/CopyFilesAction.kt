...
class CopyFilesAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        ApplicationManager.getApplication().runReadAction {
            for (file in allFiles) {
                if (file.isDirectory) continue // Should be handled by collectFiles, but as a safeguard
                ...
                try {
                    ...
                    if (document != null) {
                        ...
                        // Fallback for binary or very large files, try to read bytes
    ...
    private fun getRelativePath(project: Project, file: VirtualFile): String {
        ...
        return file.name // Fallback if no base path or not under base path
    }
